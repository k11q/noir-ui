 ...
 let trigger = element.querySelector('[data-tooltip-trigger]')
 let tooltip = element.querySelector('[role=tooltip]')
 let tooltipPosition = this.getTooltipPosition()
 let globalEscapeBound = this.globalEscape.bind(this)
 let globalPointerDownBound = this.globalPointerDown.bind(this)
